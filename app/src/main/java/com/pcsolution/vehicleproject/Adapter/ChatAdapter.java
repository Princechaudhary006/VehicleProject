...
public class ChatAdapter extends RecyclerView.Adapter{
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if(holder.getClass()==SenderViewVolder.class){
            ((SenderViewVolder)holder).senderViewVolderMsg.setText(messageModel.getMessage());
        }else{
    ...
    public static class RecieverViewVolder extends RecyclerView.ViewHolder{
    ...
    public static class SenderViewVolder extends RecyclerView.ViewHolder{
        ...
        TextView senderViewVolderMsg,senderViewVoldertime;
        public SenderViewVolder(@NonNull View itemView) {
            super(itemView);
            senderViewVolderMsg=itemView.findViewById(R.id.sender_msg);
            senderViewVoldertime=itemView.findViewById(R.id.sender_msg_time);
        }
    }
